...
export  default function Admin() {
    ...
    return (
        <div className='text-center'>
            <h1 className='mt-10 font-extrabold text-2xl mb-8' >Add a new product</h1>
            ...
            >
                <div className='flex-1 mb-5' >
                    ...
                    <div className='flex-1 mb-2'>Product description</div>
                    <textarea
                        onChange={(e) => setDescription(e.target.value)}
                        className='border p-1 text-black mb-4'
                    />

                    <div className='flex-1 mb-2'>Product Price [required]</div> 
                    <input
                        pattern='^\d*(\.\d{0,2})?$'
